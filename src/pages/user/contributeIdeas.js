...
const ContributeIdeas = () => {
  ...
  return (
    <div
      className="contact p-6 bg-gray-300 rounded-lg shadow-md max-w-3xl mx-auto my-10"
      data-aos="fade-up"
    >
      <div className="flex flex-col md:flex-row">
        <div className="contact-col mb-6 md:mb-0 md:pr-6 md:border-r md:border-gray-300 md:w-1/2">
          <h3 className="text-2xl font-bold flex items-center mb-2">
            Send us a message{" "}
            <RiStarLine className="ml-2 text-yellow-500 animate-spin" />
          </h3>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                required
                className="w-full px-4 py-2 bg-gray-100 ring-gray-500 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 h-40"
              ></textarea>
            </div>
