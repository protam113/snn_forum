...
import Logo_404 from "../../assets/img/illustration.svg";
      ...
      <div className="container min-h-screen px-6 py-8 mx-auto lg:flex lg:items-center lg:gap-12">
        <div className="wf-ull lg:w-1/2">
          ...
          <div className="flex items-center mt-6 gap-x-3">
            ...
            <Link
              to="/"
              className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-main-blue2 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600"
            >
              Đi tới trang chủ
            </Link>
          </div>
        ...
        <div className="relative w-full mt-12 lg:w-1/2 lg:mt-0">
          <img className="w-full max-w-lg lg:mx-auto" src={Logo_404} alt="" />
        </div>
      </div>
    </section>
  );
